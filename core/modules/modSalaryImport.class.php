...
class modSalaryImport extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		$this->cronjobs = array(
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/salaryimport/class/myobject.class.php',
			//      'objectname' => 'MyObject',
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => 'isModEnabled("salaryimport")',
			//      'priority' => 50,
			//  ),
		);
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'isModEnabled("salaryimport")', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("salaryimport")', 'priority'=>50)
		// );
		...
		*/
		...
		$this->menu[$r++]=array(
			...
			'leftmenu'=>'salaryimport_myobject_list',
			'url'=>'/salaryimport/myobject_list.php',
		...
		$this->menu[$r++]=array(
			...
			'titre'=>'New_MyObject',
			'mainmenu'=>'salaryimport',
			'leftmenu'=>'salaryimport_myobject_new',
			'url'=>'/salaryimport/myobject_card.php?action=create',
			'langs'=>'salaryimport@salaryimport',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("salaryimport")', // Define condition to show or hide menu entry. Use 'isModEnabled("salaryimport")' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=>'$user->hasRight("salaryimport", "myobject", "write")'
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);*/
		...
		$this->export_icon[$r]='myobject@salaryimport';
		// Define $this->export_fields_array, $this->export_TypeFields_array and $this->export_entities_array
		$keyforclass = 'MyObject'; $keyforclassfile='/salaryimport/class/myobject.class.php'; $keyforelement='myobject@salaryimport';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		//$this->export_fields_array[$r]['t.fieldtoadd']='FieldToAdd'; $this->export_TypeFields_array[$r]['t.fieldtoadd']='Text';
		//unset($this->export_fields_array[$r]['t.fieldtoremove']);
		//$keyforclass = 'MyObjectLine'; $keyforclassfile='/salaryimport/class/myobject.class.php'; $keyforelement='myobjectline@salaryimport'; $keyforalias='tl';
		//include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='myobject'; $keyforaliasextra='extra'; $keyforelement='myobject@salaryimport';
		include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$keyforselect='myobjectline'; $keyforaliasextra='extraline'; $keyforelement='myobjectline@salaryimport';
		//include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		...
		$this->import_icon[$r]='myobject@salaryimport';
		$this->import_tables_array[$r] = array('t' => MAIN_DB_PREFIX.'salaryimport_myobject', 'extra' => MAIN_DB_PREFIX.'salaryimport_myobject_extrafields');
		...
		$this->import_fieldshidden_array[$r] = array('extra.fk_object' => 'lastrowid-'.MAIN_DB_PREFIX.'salaryimport_myobject');
		...
		$this->import_convertvalue_array[$r] = array(
			't.ref' => array(
				'rule'=>'getrefifauto',
				'class'=>(empty(getDolGlobalString('SALARYIMPORT_MYOBJECT_ADDON')) ? 'mod_myobject_standard' : getDolGlobalString('SALARYIMPORT_MYOBJECT_ADDON')),
				'path'=>"/core/modules/commande/".(empty(getDolGlobalString('SALARYIMPORT_MYOBJECT_ADDON')) ? 'mod_myobject_standard' : getDolGlobalString('SALARYIMPORT_MYOBJECT_ADDON')).'.php'
				'classobject'=>'MyObject',
				'pathobject'=>'/salaryimport/class/myobject.class.php',
			),
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'salaryimport');
		...
		//$result1=$extrafields->addExtraField('salaryimport_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'salaryimport@salaryimport', 'isModEnabled("salaryimport")');
		//$result2=$extrafields->addExtraField('salaryimport_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'salaryimport@salaryimport', 'isModEnabled("salaryimport")');
		//$result3=$extrafields->addExtraField('salaryimport_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'salaryimport@salaryimport', 'isModEnabled("salaryimport")');
		//$result4=$extrafields->addExtraField('salaryimport_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'salaryimport@salaryimport', 'isModEnabled("salaryimport")');
		//$result5=$extrafields->addExtraField('salaryimport_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'salaryimport@salaryimport', 'isModEnabled("salaryimport")');
		...
		// Document templates
		$moduledir = dol_sanitizeFileName('salaryimport');
		$myTmpObjects = array();
